...
(1, 'The Great Gatsby', 55000, 180, 'tb1.png', 'Novel klasik karya F. Scott Fitzgerald...', 'tb1alt.png', 7),
(2, 'Sapiens', 75000, 220, 'tb2.png', 'Buku non-fiksi karya Yuval Noah Harari...', 'tb2alt.png', 7),
(3, 'Pride and Prejudice', 48000, 170, 'tb3.png', 'Novel klasik karya Jane Austen...', 'tb3alt.png', 3),
(4, 'Project Hail Mary', 85000, 280, 'tb4.png', 'Novel fiksi ilmiah karya Andy Weir...', 'tb4alt.png', 0),
(5, 'The Final Girl Support Group', 62000, 190, 'tb5.png', 'Novel thriller psikologis karya Grady Hendrix...', 'tb5alt.png', 6),
(6, 'Klara and the Sun', 69000, 200, 'tb6.png', 'Novel fiksi spekulatif karya Kazuo Ishiguro...', 'tb6alt.png', 5),
(7, 'The Paper Palace', 78000, 240, 'tb7.png', 'Novel drama keluarga karya Miranda Cowley...', 'tb7alt.png', 3),
(8, 'Doraemon: Stand By Me', 70000, 120, 'tb8.png', 'Bercerita tentang persahabatan Nobita & Doraemon...', 'tb9alt.png', 3),
(9, 'Sherlock Holmes: A Study in Scarlet', 55000, 200, 'tb9.png', 'Buku pertama dari serial Sherlock Holmes...', 'tb9alt.png', 5),
(10, 'The Lord of the Rings', 90000, 250, 'tb10.png', 'Awal dari trilogi epik fantasi karya Tolkien...', 'tb10alt.png', 3);
